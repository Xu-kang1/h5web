    ...
    <div class="bg">
       ...
       <!-- <mt-swipe :show-indicators="false">
        ...
        <div class="btm">
            ...
            <div @click="getMoney" class="btn" id="btn"></div>
        </div>
...
.bg{
    ...
    height:100%;
    min-height: 6.4rem;
    background-image: url('../../../static/777.png');
        ...
        .alert{
            ...
            .sheet{
                ...
                .confirm{
                    ...
                    box-shadow: 0.01rem 0.02rem 0.05rem 0 rgba(79, 140, 255, 0.65);
                    border-radius: .05rem;
                    display: flex;
                    justify-content: center;
                    span{
